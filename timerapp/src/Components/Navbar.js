...
const Navbar = (props) => {
    return (
        <div className="navbar">
                <NavLink to="/" className={"navbar-item navbar-left"} activeClassName="active" activeStyle={{ color: "orange" }} id="homepage"> <li className="flmdlogo"><img src={logo} alt="logo" width="50px" height="50px"/></li>&#160;&#160;&#160;<b>Flowmoro</b></NavLink>
